...
@router.post("/personal-context/status", response_model=UserStatus)
...
@router.get("/personal-context/status", response_model=UserStatus)
...
@router.patch("/personal-context/status", response_model=UserStatus)
...
@router.delete("/personal-context/status", response_model=UserStatus)
